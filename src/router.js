...
export default new Router({
  ...
  routes: [
    ...
    { meta: { title: "スプラトゥーン2ブキクイズ", layout: "simple",    }, path: '/splatoon2_weapon_quiz',       name: 'splatoon2_weapon_quiz',       component: () => import(/* webpackChunkName: "splatoon2_weapon_quiz" */ './views/splatoon2_weapon_quiz.vue'),               },
    { meta: { title: "スプラトゥーン2ブキクイズ2"                      }, path: '/splatoon2_weapon_quiz2',       name: 'splatoon2_weapon_quiz2',       component: () => import(/* webpackChunkName: "splatoon2_weapon_quiz2" */ './views/splatoon2_weapon_quiz2.vue'),               },
    { meta: { title: "スプラトゥーン2ブキクイズ3"                      }, path: '/splatoon2_weapon_quiz3',       name: 'splatoon2_weapon_quiz3',       component: () => import(/* webpackChunkName: "splatoon2_weapon_quiz3" */ './views/splatoon2_weapon_quiz3.vue'),               },
