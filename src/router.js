...
export default new Router({
  ...
  routes: [
    ...
    { meta: { title: "将棋盤",                                         }, path: '/shogi_player_test',                name: 'shogi_player_test',                component: () => import(/* webpackChunkName: "shogi_player_test" */ './views/shogi_player_test.vue'),                       },
    ...
    { meta: { title: "スプラトゥーン2ブキめいクイズ", layout: "nothing",    }, path: '/splatoon2_weapon_quiz',       name: 'splatoon2_weapon_quiz',       component: () => import(/* webpackChunkName: "splatoon2_weapon_quiz" */ './views/splatoon2_weapon_quiz.vue'),               },
