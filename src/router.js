...
export default new Router({
  ...
  routes: [
    ...
    { meta: { title: "スプラトゥーン2ブキめいクイズ", layout: "simple",    }, path: '/splatoon2_weapon_quiz',       name: 'splatoon2_weapon_quiz',       component: () => import(/* webpackChunkName: "splatoon2_weapon_quiz" */ './views/splatoon2_weapon_quiz.vue'),               },
