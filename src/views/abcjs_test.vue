...
.abcjs_test
  ...
  .columns
    .column
      ...
      .content
        ul
          li https://qiita.com/stkay/items/08e7fe5ec1f5546f89a8
...
E D E/E/ D|E D E/E/ D|E D E/E/ D|E D E/E/ D|`
  ...
  watch: {
    abc_body() {
      abcjs.renderAbc("score_element", this.abc_body)
      abcjs.renderMidi("midi_element", this.abc_body)
    },
  },
}
</script>
...
@import "../assets/scss/abcjs-midi.css"
